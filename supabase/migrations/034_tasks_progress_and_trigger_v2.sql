-- 034: Add progress_notes to tasks + enhanced trigger
-- - Adds progress_notes column to tasks
-- - When plan is ready (todo), update task title/description from missions_plans
-- - Sync progress_notes from missions to tasks on every change
