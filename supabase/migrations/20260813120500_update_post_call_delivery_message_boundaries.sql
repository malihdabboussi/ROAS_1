-- Keep the client-ready Pixel draft free of internal review structure.
-- The Slack review formatter owns Call Summary, Call Recording, and Action Items.
...
5. Write only the client-ready recap in `message`. The review formatter owns the internal `Call Recording` link, so do not add a recording link or internal section headings to the client message.
