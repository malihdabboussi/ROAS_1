...
WHERE s.skill_key = l.skill_key
  ...
  AND s.skill_key IN ('roas-market-research', 'roas-ad-kit', 'roas-ad-design', 'roas-webinar-audit', 'roas-webinar-copy-package', 'roas-webinar-topics', 'roas-landing-page-copy', 'roas-video-ad-scripts', 'roas-image-brief', 'roas-funnel-design', 'roas-webinar-deck', 'instagram-carousel-design');
