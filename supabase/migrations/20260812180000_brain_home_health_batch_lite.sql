-- Brain Home batch health: stop calling brain_legend_connection_counts per brain.
-- That per-row legend RPC was timing out on fleets of Person Brains (~20+) and left
-- /api/brain/health/batch returning 5xx while the UI stayed stuck on "Loading".
