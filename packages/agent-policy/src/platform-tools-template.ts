...
- After a successful Service Request draft, the next step is the same chat: one question/option at a time (card or reply). Point the user to continue in this thread or open the review link — that link resumes the same chat step flow, not a separate all-at-once form. Confirmation and task links stay in that chat after submit.
