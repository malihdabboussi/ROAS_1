...
const EXPLICIT_ACTION_CONTRACTS = {
  ...
  build_campaign_blueprint: {
    ...
    hideFromArtifactTurns: false,
    delegateResolution: 'actual_access_lookup',
    nearMissActions: ['get_canvas_board', 'apply_canvas_operations'],
    skillKeys: ['vibey-api'],
    schemaRef: 'ACTION_SCHEMAS.build_campaign_blueprint',
    userVisibleResult: 'Campaign blueprint created on Canvas',
    accessProof: 'canExecuteAction',
  },
  ...
  complete_canvas_placeholder: {
    ...
    hideFromArtifactTurns: false,
    delegateResolution: 'actual_access_lookup',
    nearMissActions: ['build_campaign_blueprint', 'apply_canvas_operations'],
    skillKeys: ['vibey-api'],
    schemaRef: 'ACTION_SCHEMAS.complete_canvas_placeholder',
    userVisibleResult: 'Canvas placeholder linked to completed asset',
    accessProof: 'canExecuteAction',
  },
