export type BrainTemporalStatus = 'current' | 'historical' | 'superseded' | 'contradicted' | 'expired';
...
export declare function temporalCandidateMetadata(row: Record<string, unknown>): BrainTemporalMetadata;
