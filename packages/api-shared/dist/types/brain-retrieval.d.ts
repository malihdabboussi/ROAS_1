...
export type BrainCandidateKind = 'memory' | 'snapshot' | 'sk_entry' | 'narrative_page' | 'belief_pattern' | 'perspective' | 'company_object' | 'company_signal' | 'customer_avatar' | 'avatar_axis' | 'evidence_chunk' | 'timeline' | 'timeline_item';
