...
export type AgentToolErrorEffectState = 'failed_before_effect' | 'partial_effect' | 'succeeded_delivery_failed' | 'unknown_effect';
export type AgentToolRetryPolicyMode = 'retry_same_payload' | 'retry_with_corrected_payload' | 'retry_after_delay' | 'do_not_retry_use_fallback' | 'do_not_retry_needs_user_action' | 'do_not_retry_terminal';
