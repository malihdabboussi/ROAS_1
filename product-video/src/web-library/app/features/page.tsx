...
import { ArrowRight, BookOpen, Brain, MessageSquare, Plug, Server, Target, Users, Zap } from 'lucide-react'
import type { LucideIcon } from 'lucide-react'
import { Footer } from '@/components/Footer'

export const metadata: Metadata = {
  title: 'Features | Vibey',
  description: 'Eight pieces. One system. Everything your AI workforce needs to run your business alongside you.',
}

const features: { href: string; title: string; subtitle: string; icon: LucideIcon }[] = [
  { href: '/features/your-team', title: 'Your Team', subtitle: 'Hire, train, and manage specialist agents', icon: Users },
  { href: '/features/the-brain', title: 'The Brain', subtitle: 'Three layers of memory that compound', icon: Brain },
        ...
        <div className="site-container">
          <div className="mx-auto max-w-3xl text-center mb-16">
            ...
            <p className="text-color-muted body-1 mt-4">
              Eight pieces. One system. Everything your AI workforce needs to run your business alongside you.
            </p>
          </div>
