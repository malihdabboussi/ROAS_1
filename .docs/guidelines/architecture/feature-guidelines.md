...
3. [AI Content Formatting](#3-ai-content-formatting) ............................... Line ~600
   3.5. [OpenRouter Prompt Caching (MANDATORY)](#35-openrouter-prompt-caching-mandatory) ... Line ~750

**VIBEY PERSONA (UNIVERSAL VOICE)** 4. [Vibey Persona: Universal Voice Standard](#4-vibey-persona-universal-voice-standard) Line ~1000 5. [Voice Guidelines by Context](#5-voice-guidelines-by-context) ................... Line ~950 6. [Error & Message Config Structure](#6-error--message-config-structure) .......... Line ~1250

**WEB SCRAPING & VALIDATION** 7. [Web Scraping with Fallback](#7-web-scraping-with-fallback) .................... Line ~1500

**ERROR LOGGING & MONITORING** 8. [Admin Error Logging](#8-admin-error-logging) ................................... Line ~1650

**UI STANDARDS** 9. [Page Layout Design Standards](#9-page-layout-design-standards) ............... Line ~1850
...
<!-- ============================================================================
   SECTION 3: AI CONTENT FORMATTING
   ============================================================================ -->

## 3. AI Content Formatting
...
<!-- ============================================================================
   SECTION 3.5: OPENROUTER PROMPT CACHING (MANDATORY)
   ============================================================================ -->

## 3.5. OpenRouter Prompt Caching (MANDATORY)
...
**See `.docs/guidelines/development/code-guidelines.md` Section: "OpenRouter Actual Cost Tracking (MANDATORY)" for implementation details.**

---

<!-- ============================================================================
   SECTION 4: VIBEY PERSONA - UNIVERSAL VOICE STANDARD
   ============================================================================ -->

## 4. Vibey Persona: Universal Voice Standard
...
<!-- ============================================================================
   SECTION 5: VOICE GUIDELINES BY CONTEXT
   ============================================================================ -->

## 5. Voice Guidelines by Context
...
<!-- ============================================================================
   SECTION 6: ERROR & MESSAGE CONFIG STRUCTURE
   ============================================================================ -->

## 6. Error & Message Config Structure
...
<!-- ============================================================================
   SECTION 7: WEB SCRAPING WITH FALLBACK
   ============================================================================ -->

## 7. Web Scraping with Fallback
...
<!-- ============================================================================
   SECTION 8: ADMIN ERROR LOGGING
   ============================================================================ -->

## 8. Admin Error Logging
...
- **🔍 Complete Visibility:** Capture auth and validation failures in server logs
...
- [ ] Test route to confirm failures are logged server-side

---

<!-- ============================================================================
   SECTION 9: PAGE LAYOUT DESIGN STANDARDS
   ============================================================================ -->

## 9. Page Layout Design Standards
...
**See `.docs/guidelines/design/design-guidelines.md` for complete UI standards.**
...
- Backend patterns: `.docs/guidelines/architecture/backend-architecture.md`
