...
def main() -> int:
    ...
    api_vars = [
        ...
        'APP_URL', 'API_URL', 'CORS_ORIGIN', 'PLATFORM_API_URL', 'APPS_DOMAIN_SUFFIX',
        ...
        'OPENROUTER_API_KEY', 'OPENROUTER_BACKGROUND_API_KEY', 'OPENROUTER_MEDIA_API_KEY',
        'COMPOSIO_API_KEY', 'COMPOSIO_BASE_URL',
        'SENDGRID_API_KEY', 'FIRECRAWL_API_KEY', 'GEMINI_API_KEY', 'GEMINI_API_KEY_FALLBACK', 'GEMINI_API_KEY_FALLBACK_2',
    ...
    fly_vars = [
        ...
        'MAIN_API_URL', 'INTERNAL_API_TOKEN', 'GEMINI_API_KEY', 'GEMINI_API_KEY_FALLBACK', 'GEMINI_API_KEY_FALLBACK_2', 'COMPOSIO_API_KEY',
        'OPENROUTER_API_KEY', 'OPENROUTER_INTERACTIVE_API_KEY',
        'OPENROUTER_BACKGROUND_API_KEY', 'OPENROUTER_MEDIA_API_KEY',
