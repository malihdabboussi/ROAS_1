...
CHECKS=(
  "roas-api:prj_YwUti53Q9vB6rMKPB5cpW8w7h0qL:FLY_RUNTIME_APP,APPS_DOMAIN_SUFFIX,OPENROUTER_API_KEY,OPENROUTER_BACKGROUND_API_KEY,OPENROUTER_MEDIA_API_KEY,COMPOSIO_API_KEY,SENDGRID_API_KEY,FIRECRAWL_API_KEY,GEMINI_API_KEY,SCRAPECREATORS_API_KEY,DATAFORSEO_LOGIN,DATAFORSEO_PASSWORD,SEARCHAPI_API_KEY"
