...
if [[ -z "${RAILWAY_TOKEN}" ]]; then
  ...
  echo "  3. mission-worker (roas-platform): root EMPTY (repo root — needs packages/*), config /apps/mission-worker/railway.json, Dockerfile docker/mission-worker.Dockerfile"
