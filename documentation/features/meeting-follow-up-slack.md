...
**Last Modified:** 2026-08-17 (meeting action items use the All Tasks native list)
...
9. Every workspace has one persistent meeting conversation. Opening the workspace does not steal whatever chat is already open. **Continue in chat** (and recap/follow-up actions) selects that linked conversation and attaches meeting-aware context.
