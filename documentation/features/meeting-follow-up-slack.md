...
**Last Modified:** 2026-08-17 (named-client lookup binds this portal chat CONNECTIONS; meeting workspace header Continue in chat; recordings and attachments share one card; action items use the All Tasks native list)
