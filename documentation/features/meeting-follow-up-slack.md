...
**Last Modified:** 2026-08-20 (All Meetings Client / Campaign, Host, Call status columns)
...
- **2026-08-20:** All Meetings default columns are Name, Call Kind, Client / Campaign, Host, Call date, Call status, Recording. Space and Priority are hidden on that view. Task Status dots hide unless Status is a visible column.
