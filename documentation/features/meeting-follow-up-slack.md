...
- **2026-08-29:** Campaign-status questions bypass broad Brain preload before scope validation. Without a resolved client campaign they fail closed immediately; with one, the campaign route explicitly reads live reporting, Campaign Brain, and open campaign tasks from that same campaign.
