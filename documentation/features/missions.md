...
- **IG organic video rendering**: The production skill executes its bundled Pillow renderer from `skills/ig-organic-video-ad/assets/render_ig_story.py` in the synchronized agent workspace. Mission working directories do not contain the bundled skill resource.
