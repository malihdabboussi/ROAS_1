...
- **Ads Research visual proof**: Competitive research must persist at least three mission-linked saved searches and 12 unique visual references. Duplicate ads across queries do not increase the count. Blaze assembles the complete market research Doc before one final save so failed draft-rewrite loops cannot leave a partial deliverable behind.
