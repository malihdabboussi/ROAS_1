...
Six industry packs with three clean preset scenes each: trades & home services, health & fitness, insurance & professional, real estate & mortgage, coaching, and social/influencer. Production and Quick Missions filter lifestyle vs industry-adjacent. The skill prefers industry-adjacent for matching educator verticals and reuses industry presets when `reuse_when_available` is selected.
