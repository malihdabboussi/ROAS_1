...
- **Client detail** is a quick account-manager briefing surface with Page Grader overview and client information plus current ROAS-mapped campaigns, fulfillment tasks, and client requests. Its **Chats & Missions** tab lists ROAS conversations and top-level missions scoped to the mapped client campaign; chats open in the shared chat drawer and missions open in the shared mission detail surface.
