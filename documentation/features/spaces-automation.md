...
- 2026-07-29: External-client findings remain protected Signals, while operational internal alerts use a cooling-and-recheck lifecycle before following the recipient's person-level delivery setting. An Internal person marked Active receives only a still-unresolved alert outside quiet hours, even while the detector remains in Shadow. Resolved findings are dismissed, unavailable source evidence stays reviewable, Shadow and Off recipients keep proposals, and post-call recaps remain immediate through their separate flow.
...
- 2026-08-06: Added `personal_moment` as a first-class Team Intelligence signal for high-confidence public personal/team moments (birthday, work anniversary, promotion, major milestone, strong recognition, cultural/team moment). Detection requires multiple independent public messages or one unambiguous explicit source; conflicting evidence is suppressed. Moments cool for ~8 minutes, dedupe by recipient + event type + local date, enrich with at most one clearly related historical Slack connection, store source evidence for follow-ups, and deliver as a bespoke standalone Active DM (never the numbered EOD digest). Shadow keeps a reviewable proposal without sending. External people never receive personal-moment outreach, and private Brain details never appear in the Slack copy.
