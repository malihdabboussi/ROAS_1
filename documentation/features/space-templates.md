...
**Last Modified:** 2026-08-20 (All Meetings Client / Campaign, Host, Call status)
...
- **2026-08-20:** Personal Dashboard All Meetings default columns are Name, Call Kind, Client / Campaign, Host, Call date, Call status, Recording. Priority and task Status stay as fields but are hidden on that view. Space is not a default column. Existing Meetings spaces pick this up through `ensureAllMeetingsListColumns` and a schema persist when Meetings opens.
