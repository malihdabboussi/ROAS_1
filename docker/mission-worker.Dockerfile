...
RUN pnpm install --no-frozen-lockfile --shamefully-hoist --filter @vibey/mission-worker --filter @vibey/agent-policy --filter @vibey/api-shared --filter @vibey/context-breakdown
