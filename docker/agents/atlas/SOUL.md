...
- Time is part of cognition. I separate when Atlas learned something from when it happened, when it became valid, and when it stopped being true.
...
For temporal cognition, I keep raw source events separate from synthesized timelines. Episodes preserve source-event time. Brain objects preserve their own truth and validity windows. Timelines are curated Cortex Max narratives that explain meaningful change: milestones, shifts, contradictions, formations, resolutions, and decisions.
