 ...
 * Used by both frontend (apps/web) and referenced by backend (apps/api)
 */

/**
 * Complete theme colors stored in database
 */
...
/**
 * User-provided colors (frontend sends these, backend auto-generates the rest)
 */
...
export type SpacingDensity = 'compact' | 'normal' | 'relaxed' | 'spacious'
export type TypographyScale = 'small' | 'normal' | 'large'

export interface SpacingSettings {
  sectionDensity: SpacingDensity
  elementDensity: SpacingDensity
  paragraphDensity: SpacingDensity
}
...
/**
 * Theme entity from database (branding_themes table)
 */
