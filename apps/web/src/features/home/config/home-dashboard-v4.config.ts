...
export const HOME_DASHBOARD_TEMPLATES: HomeDashboardTemplate[] = [
  {
    ...
    icon: Image,
    tilt: -7,
    placeholder: 'Tell Pixel about your social post…',
  },
  {
    id: 'ad',
    label: 'New ad',
    icon: Megaphone,
    tilt: 4,
    placeholder: 'Tell Pixel about your new ad…',
  },
  {
    id: 'funnel',
    label: 'Funnel',
    icon: LayoutTemplate,
    tilt: -3,
    placeholder: 'Tell Pixel about your funnel…',
  },
  {
    id: 'design',
    label: 'Design',
    icon: Palette,
    tilt: 5,
    placeholder: 'Tell Pixel about your design…',
  },
  {
    id: 'deck',
    label: 'Slide deck',
    icon: Presentation,
    tilt: -4,
    placeholder: 'Tell Pixel about your slide deck…',
  },
  {
    id: 'email',
    ...
    icon: Mail,
    tilt: 6,
    placeholder: 'Tell Pixel about your email sequence…',
  },
]
