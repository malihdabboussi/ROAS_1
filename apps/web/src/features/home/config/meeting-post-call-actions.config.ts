...
export const MEETING_FOLLOW_UP_REVIEW_PROMPT = [
  ...
  '- After I tell you the delegation review is complete, refine the prepared follow-up message using the final confirmed tasks and their real statuses.',
  '- Keep the Slack-ready shape: a natural greeting, one concise “As discussed…” takeaway, “Here’s our hit list of actions on our end:”, status-led bullets using (DONE), (IN PROGRESS), or (TO-DO), and a short forward-looking close.',
  '- Include however many grounded follow-ups remain in the meeting records. Do not preserve or invent a fixed task count, and do not mark work done without evidence.',
