...
import { PresentationArtifactMenuDropdown } from '@/components/artifacts'
import type {
...
import { usePresentationMenuActions } from './use-presentation-menu-actions'
...
export function PresentationMenuDropdown({
  presentation,
  anchorRef,
  onClose,
  onChanged,
