...
import { AdMenuDropdown } from './AdMenuDropdown'
...
const actionsMock = vi.hoisted(() => ({
  ...
  viewAnalytics: vi.fn(),
  deleteAd: vi.fn(),
  displayName: 'Launch Ad',
}))

vi.mock('./use-ad-menu-actions', () => ({
...
describe('AdMenuDropdown', () => {
  ...
  it('renders the current ad menu actions and settles without render churn', () => {
  ...
  it('delegates full-view, campaign, analytics, and delete actions', async () => {
