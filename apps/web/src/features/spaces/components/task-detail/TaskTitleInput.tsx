...
export function TaskTitleInput({
  ...
  return (
    <input
      ...
      className="title-h1 w-full cursor-text rounded-md border-0 border-transparent bg-transparent px-2 py-1 text-left text-[var(--color-foreground)] outline-none ring-0 transition-colors placeholder:text-[var(--color-muted-foreground)] hover:bg-[var(--color-hover-subtle)] focus:ring-0 focus-visible:bg-[var(--color-hover-subtle)]"
