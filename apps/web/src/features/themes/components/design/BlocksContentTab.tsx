...
import type { BlockDesignSettings } from '../../types'

interface BlocksContentTabProps {
  value: BlockDesignSettings
  onChange: (v: BlockDesignSettings) => void
}
...
export function BlocksContentTab({ value, onChange }: BlocksContentTabProps) {
  const update = <K extends keyof BlockDesignSettings>(field: K, v: BlockDesignSettings[K]) =>
  ...
  return (
    <div className="space-y-spacing-6">
      ...
      <div className="space-y-spacing-2">
        <label className="body-3 text-muted-foreground font-medium">Block shadow</label>
        <div className="gap-spacing-2 flex">
      ...
      <div className="space-y-spacing-2">
        <label className="body-3 text-muted-foreground font-medium">Block border</label>
      ...
      <div className="space-y-spacing-2">
        <div className="flex items-center justify-between">
          <label className="body-3 text-muted-foreground font-medium">Block opacity</label>
