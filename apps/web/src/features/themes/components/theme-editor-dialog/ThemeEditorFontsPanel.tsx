...
import { FontPicker, FontWeightPicker } from '../FontPicker'

export interface ThemeEditorFontsPanelProps {
...
export function ThemeEditorFontsPanel({
  fontHeading,
  setFontHeading,
  fontHeadingWeight,
  ...
  return (
    <div className="space-y-spacing-6 max-w-xl">
      ...
      <div className="space-y-spacing-3">
        <label className="body-3 font-medium text-[var(--color-muted-foreground)]">Body</label>
