...
export interface FirefliesImportModalProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  loadingFireflies: boolean
  firefliesTranscripts: FirefliesTranscript[]
  importingMeetingId: string | null
  setImportingMeetingId: Dispatch<SetStateAction<string | null>>
}

export function FirefliesImportModal({
  open,
  onOpenChange,
  loadingFireflies,
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={async () => {
                            ...
                            try {
                              await importFirefliesTranscript(transcript.id)
