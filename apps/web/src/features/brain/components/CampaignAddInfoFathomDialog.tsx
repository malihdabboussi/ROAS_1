...
interface CampaignAddInfoFathomDialogProps {
...
export function CampaignAddInfoFathomDialog({
  importingBatch,
  loading,
  loadingMore,
  meetings,
  ...
  open,
  selectedIds,
}: CampaignAddInfoFathomDialogProps) {
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    {meetings.map((meeting) => {
                      const meetingId = getCampaignInfoMeetingId(meeting)
                        ...
                        >
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="typo-caption text-muted-foreground">
                              {formatCampaignInfoMeetingTime(meeting.created_at)}
                            </p>
                          </div>
                        </button>
                      )
