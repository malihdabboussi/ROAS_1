...
import type { BrandValues, BrandVoice } from '@/features/themes/types'

export interface ThemeSettingsBrandPanelProps {
...
export function ThemeSettingsBrandPanel({
  brandVoice,
  setBrandVoice,
  brandValues,
  setBrandValues,
}: ThemeSettingsBrandPanelProps) {
  return (
    <div>
      <div className="space-y-spacing-6 sm:space-y-spacing-8">
        <div>
          ...
          <p className="typo-caption mb-spacing-4 text-[var(--color-muted-foreground)]">
            Define how your brand communicates. This helps maintain consistency across all content.
          </p>
          <div className="space-y-spacing-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Professional, Casual, Bold, Friendly"
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Direct and confident, Warm and approachable"
                className="input-glass body-2 w-full"
              />
            </div>
            <div>
        ...
        <div>
          ...
          <p className="typo-caption mb-spacing-4 text-[var(--color-muted-foreground)]">
            Core values that define your brand and guide your messaging.
          </p>
          <div className="space-y-spacing-4">
            <div>
              <label className="body-3 mb-spacing-2 block font-medium text-[var(--color-muted-foreground)]">
              ...
              <div className="space-y-spacing-2">
                ...
                {(brandValues?.secondary?.length || 0) < 4 && (
                  <button
                    ...
                    className="gap-spacing-2 px-spacing-3 py-spacing-2 rounded-spacing-1 body-3 flex w-full items-center justify-center border border-dashed border-[var(--color-border)] font-medium text-[var(--color-muted-foreground)] transition-colors hover:bg-[var(--color-hover-subtle)]"
                  >
