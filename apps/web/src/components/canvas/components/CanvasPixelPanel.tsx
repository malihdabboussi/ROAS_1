  ...
  const systemContext = useMemo(
    () =>
      [
        ...
        'Use build_campaign_blueprint after the user confirms the plan. Derive campaign_label, stages, branches, and connections from this conversation and client evidence; these are not selectable templates. Pass the board_id above as canvas_id to every Canvas action. Use get_canvas_board immediately before any later apply_canvas_operations update.',
