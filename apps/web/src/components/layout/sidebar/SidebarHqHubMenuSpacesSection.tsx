...
export function SidebarHqHubMenuSpacesSection({
  ...
  const searchControls = spacesSearchOpen ? (
    <div className="gap-spacing-2 flex shrink-0 items-center px-2 pt-1 pb-2">
    ...
    <div className="flex items-center justify-end gap-0.5 px-2 pt-1 pb-1">
      {hiddenSidebarCount > 0 ? (
        <button
          ref={hiddenEyeRef}
          type="button"
