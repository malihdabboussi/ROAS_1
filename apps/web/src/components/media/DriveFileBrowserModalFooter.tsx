...
export function DriveFileBrowserModalFooter({
  showClose = true,
  onClose,
  onSelectFileForChat,
  onInsertDriveLinkBatch,
  selectedCount,
  batchImporting,
  batchProgress,
  onBatchImport,
  ...
  /** Inserts the currently selected files as link references and closes. */
  onInsertDriveLinkBatch?: () => void
  ...
  return (
    <div className="px-spacing-6 py-spacing-4 border-border flex items-center justify-between border-t">
      ...
      <div className="gap-spacing-2 flex items-center">
        ...
        {onInsertDriveLinkBatch && selectedCount > 0 && (
          <button
            type="button"
            onClick={onInsertDriveLinkBatch}
            className="button-glass-accent body-3 flex items-center gap-2 rounded-lg px-4 py-2 font-medium"
          >
