...
export function CampaignsHub() {
  ...
  const personalSpaces = useMemo(
    () =>
      spaces
        .filter((space) => !space.campaign_id)
  ...
  return (
    <div className="p-spacing-4 md:p-spacing-6 mx-auto w-full max-w-3xl">
      ...
      <div className="mb-spacing-4 gap-spacing-2 flex flex-col sm:flex-row">
        <label className="input-glass relative min-w-0 flex-1">
      ...
      {filteredCampaigns.length === 0 && personalSpaces.length === 0 ? (
        <div className="surface-card border-border rounded-spacing-3 border p-spacing-6 text-center">
          <FolderKanban className="text-muted-foreground mx-auto mb-spacing-2 h-8 w-8" />
        ...
        <ul className="gap-spacing-3 flex flex-col">
          ...
          {personalSpaces.length > 0 ? (
            <li className="surface-card border-border rounded-spacing-3 overflow-hidden border">
              ...
              <ul className="border-border space-y-0.5 border-t px-spacing-3 py-spacing-2">
