...
async function loadContacts(
  ...
  userId: string,
  orgId: string | null,
): Promise<Array<{ first_name?: string | null; last_name?: string | null; email?: string | null }>> {
  let query = supabase
    .from('contacts')
...
async function loadRoster(
  ...
  userId: string,
  orgId: string | null,
): Promise<Array<{ display_name?: string | null; email?: string | null; full_name?: string | null }>> {
  if (orgId) {
