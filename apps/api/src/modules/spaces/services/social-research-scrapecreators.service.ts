import { SocialResearchScrapeCreatorsServiceBase10 } from './social-research-scrapecreators-service-10.base'
...
@Injectable()
export class SocialResearchScrapeCreatorsService extends SocialResearchScrapeCreatorsServiceBase10 {
  constructor(
    api: ScrapeCreatorsApiService,
    credits: CreditsService,
    errorReporter: ErrorReporter,
  ) {
    super(api, credits, errorReporter)
  }
}
