import { SpacesServiceBase07 } from './spaces-service-07.base'
...
@Injectable()
export class SpacesService extends SpacesServiceBase07 {
  constructor(
    repo: SpacesRepository,
    permissionsService: SpacePermissionsService,
    @Optional() @Inject(SpaceAutomationService) automationService: SpaceAutomationService | null,
    userAgentApi: UserAgentApiService,
    linkPreview: LinkPreviewService,
    creditsService: CreditsService,
    notifications: SpaceNotificationsService,
