import { MEETING_LOG_AUTOMATION_SEED } from '../../spaces/data/meeting-log-automation.seed'
import {
  ASSIGNEE_FIELD,
  docBody,
  PRIORITY_FIELD,
...
const fathomMeetingLog: SpaceTemplateAutomationSeed = MEETING_LOG_AUTOMATION_SEED
