...
export const VIBEY_API_ACTION_DOCS: Record<string, VibeyActionDoc> = {
  ...
  create_campaign: {
    section: 'Campaign',
    description:
      'Creates a Vibey campaign. Use when the user explicitly asks to create a new campaign, launch workspace, or campaign container. Required: name. Optional: campaign_type and config. The result includes `url` (https://app.roas.io/campaigns/{id}). The user-facing reply must include that url as a real openable https link. Do not use this for a client Portal campaign draft — that goes through The ROAS Portal campaign-draft write and its review_url.',
    parameters:
