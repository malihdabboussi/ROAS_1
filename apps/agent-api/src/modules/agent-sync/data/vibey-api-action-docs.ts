...
export const VIBEY_API_ACTION_DOCS: Record<string, VibeyActionDoc> = {
  ...
  process_media: {
    section: 'Media',
    description:
      'Processes media files server-side, renders deterministic Validate Messaging statics, and composites exact IG Story sticker videos. Accepts asset_ref/asset_refs for connected files or direct URL fields. Use render_validate_messaging with 1-8 identity-callout lines, an exact highlight substring, and verified Theme colors; the server creates light, dark, and bold PNGs and registers them as native Space Media. Use render_ig_story for approved sticker copy; the server applies Montserrat ExtraBold Italic, one red highlighted line, an approved Apple-style emoji, 1080x1920 framing, exactly 10 seconds, H.264 video, and AAC audio. Structural, audio, visual, playback, compositing, and analysis operations use ffmpeg. Output is uploaded to campaign media.',
    parameters:
