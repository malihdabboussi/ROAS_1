...
export const VIBEY_API_ACTION_DOCS: Record<string, VibeyActionDoc> = {
  ...
  process_media: {
    section: 'Media',
    description:
      'Processes media files server-side and renders deterministic Validate Messaging statics. Accepts asset_ref/asset_refs for connected files or direct URL fields. Use render_validate_messaging with 1-8 identity-callout lines, an exact highlight substring, and verified Theme colors; the server creates light, dark, and bold PNGs and registers them as native Space Media. Structural, audio, visual, playback, compositing, and analysis operations use ffmpeg. Output is uploaded to campaign media.',
    parameters:
