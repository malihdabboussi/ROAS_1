...
/**
 * Valid actions that the vibey_backend tool can send.
 */
...
export const ArtifactActionDto = z.object({
  action: z.enum(VALID_ACTIONS),
  data: z.record(z.unknown()).optional().default({}),
})

export type ArtifactActionInput = z.infer<typeof ArtifactActionDto>
