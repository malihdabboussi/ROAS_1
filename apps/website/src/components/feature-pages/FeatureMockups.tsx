...
import { MarketingDocumentsMockup } from '@/components/marketing/MarketingDocumentsMockup'
import {
...
import { MarketingSpaceViewsMockup } from '@/components/marketing/MarketingSpaceViewsMockup'
import { MarketingSpaceDocsMockup } from '@/components/marketing/MarketingSpaceDocsMockup'
import { MarketingSpaceChannelsMockup } from '@/components/marketing/MarketingSpaceChannelsMockup'
...
export function FeatureMockupByKind({
  ...
  switch (kind) {
    ...
    case 'documents':
      return <MarketingDocumentsMockup />
    ...
    case 'space-views':
      return <MarketingSpaceViewsMockup libraryAgents={missionDetailLibraryAgents} />
    case 'space-docs':
      return <MarketingSpaceDocsMockup libraryAgents={missionDetailLibraryAgents} />
    case 'space-channels':
      return <MarketingSpaceChannelsMockup libraryAgents={missionDetailLibraryAgents} />
    case 'space-automations':
      return <MarketingSpaceAutomationsMockup libraryAgents={missionDetailLibraryAgents} />
    default:
      return null
  }
}
