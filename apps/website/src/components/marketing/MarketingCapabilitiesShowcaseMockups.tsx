...
export function MarketingCapabilitiesGtmMockup({
  ...
  if (embedTransparent) {
    return (
      <div className="flex min-h-[440px] w-full flex-col rounded-2xl bg-transparent">{inner}</div>
    )
  }
  return (
...
export function MarketingCapabilitiesMediaMockup({
  ...
  if (embedTransparent) {
    return <div className="min-h-0 w-full rounded-2xl bg-transparent sm:min-h-[440px]">{inner}</div>
  }
...
export function MarketingCapabilitiesOpsMockup({
  ...
  return <FeatureFloatingMockShell className="!min-h-[440px]">{inner}</FeatureFloatingMockShell>
}
