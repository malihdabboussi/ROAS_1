      ...
      <div className="agent-profile-card-glass relative flex h-full flex-col overflow-hidden border-0">
        <div className="shrink-0">
          {row.image_url ? (
            ...
            <div className="flex h-56 w-full items-center justify-center bg-color-subtle" />
          )}
        </div>
            ...
            <div className="agent-profile-tabs-row flex flex-wrap gap-0.5 p-1">
              {TABS.map((t) => (
                <button
                  ...
                  className={
                    tab === t.id
                      ? 'agent-profile-tab agent-profile-tab-active body-3 flex min-h-9 flex-1 items-center justify-center rounded-md px-2 py-1 font-medium'
          ...
          >
            {tab === 'info' && (
              <div className="gap-spacing-3 flex flex-col px-3">
                <div className="gap-spacing-2 flex items-start justify-between">
                  <div className="min-w-0 flex-1 text-left">
                    <div className="flex items-baseline justify-between gap-2">
                      <h2 className="min-w-0 text-base font-bold uppercase leading-tight">
                        <span className="text-[var(--text-primary)] dark:text-[var(--text-on-dark-pure)]">
                          {nameUpper}
                        </span>{' '}
                        <span className="body-3 font-medium normal-case text-[var(--text-muted)]">
                          ({row.role})
                        </span>
                      </h2>
                    </div>
                ...
                <div className="space-y-2 text-left">
                  ...
                  <div className="gap-spacing-3 rounded-spacing-2 flex items-center border border-color-glass bg-color-subtle px-3 py-2">
              ...
              <div className="space-y-2 px-3 text-left">
                {skillDetails.length === 0 ? (
                  ...
                  skillDetails.map((skill) => (
                    <div
                      key={skill.skill_key}
                      className="rounded-spacing-2 border border-color-glass bg-color-subtle p-3"
                    >
            ...
            {tab === 'comms' && (
              <div className="space-y-3 px-3 text-left">
                ...
                <div className="border-t border-color-glass pt-3">
                  <p className="body-4 text-text-muted/60 mb-2 uppercase tracking-wide">Channels</p>
                  <button
                    type="button"
                    disabled
                    className="rounded-spacing-2 mb-2 w-full border border-dashed border-color-glass bg-color-subtle px-3 py-3 text-left"
                  >
                  ...
                  <button
                    type="button"
                    disabled
                    className="rounded-spacing-2 w-full border border-dashed border-color-glass bg-color-subtle px-3 py-3 text-left"
                  >
                    <div className="flex items-center gap-2">
                ...
                <div className="border-t border-color-glass pt-3">
                  ...
                  <div className="rounded-spacing-2 flex items-center justify-between border border-color-glass bg-color-subtle px-3 py-2">
                    <div>
            ...
            {tab === 'context' && (
              <div className="space-y-3 px-3 text-left">
                <div>
                  ...
                  <div className="rounded-spacing-2 flex items-center justify-between gap-3 border border-color-glass bg-color-subtle px-3 py-2">
