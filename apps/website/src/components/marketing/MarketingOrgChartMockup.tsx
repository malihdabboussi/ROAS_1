    ...
    <FeatureFloatingMockShell className="!min-h-[360px]">
      <div className="relative flex min-h-[360px] w-full flex-col justify-center px-2 py-4 sm:px-3">
        <div className="flex justify-center">
          <div className="surface-card border-subtle flex min-w-0 max-w-[200px] flex-col items-center gap-1.5 rounded-xl px-5 py-3">
        ...
        <div className="grid grid-cols-4 gap-0">
          {marketingAgents.map((agent) => (
            <div key={agent.role_key} className="px-1">
              <div className="surface-card border-subtle flex min-w-0 flex-col items-center gap-1 rounded-lg px-1 py-2 sm:px-1.5 sm:py-2.5">
                <img
                  src={agent.image_url}
                  alt=""
