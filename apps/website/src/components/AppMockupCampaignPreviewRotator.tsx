...
function OfferPane() {
  return (
    <div className="site-mock-dark studio-app-preview-root h-full min-h-0 overflow-hidden">
      <MockupOfferPreview />
    </div>
  )
}
...
function FunnelPane({ glass }: { glass: CampaignPreviewGlass }) {
  ...
  return (
    <div className="site-mock-dark studio-app-preview-root flex h-full min-h-0 flex-col overflow-hidden">
