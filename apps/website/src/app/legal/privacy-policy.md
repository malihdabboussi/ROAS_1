...
We allow third-party vendors to use cookies or similar technologies to collect information about your browsing activities over time following your use of the site. We use the following third-party tracking and analytics services:

Google Analytics – a web analytics service provided by Google, Inc. (“Google”). Google Analytics uses cookies to help us analyze how you use the online and mobile resources and enhance your experience when you visit the online and mobile resources. Data collected includes pages visited, time on site, browser type, and IP address. For more information on how Google uses this data, go to Google’s Privacy & Terms. You can opt out of Google Analytics by installing the Google Analytics Opt-out Browser Add-on.

Meta Pixel – a tracking tool provided by Meta Platforms, Inc. (“Meta”). The Meta Pixel collects data about your interactions with our website, including pages viewed and actions taken, for the purpose of measuring the effectiveness of our advertising campaigns and delivering relevant ads on Meta platforms (Facebook and Instagram). Data collected may include your IP address, browser information, and on-site behavior. For more information, visit Meta’s Privacy Policy. You can opt out of Meta’s use of this data for advertising purposes through your Facebook Ad Preferences.

Microsoft Clarity – a behavioral analytics service provided by Microsoft Corporation. Microsoft Clarity records session replays, heatmaps, and user interaction data (such as clicks, scrolls, and mouse movements) to help us understand how visitors use our website and improve the user experience. Data collected may include IP address, browser type, pages visited, and interaction patterns. Microsoft Clarity does not collect personally identifiable information such as names or email addresses. For more information, visit Microsoft’s Privacy Statement. You can opt out by visiting Microsoft’s privacy opt-out page.
...
You can exercise these rights up to two different times every 12 months. To do so, just contact us at info@vibey.im. We may ask you to fill out a request form. The CCPA only allows us to act on your request if we can verify your identity or your authority to make the request, so you will also need to follow our instructions for identity verification.
...
We collect only the Google User Data necessary to provide the features you have explicitly enabled. This may include your Google account email address, profile information, calendar events, email metadata and content, and other data from Google services you authorize.
...
Use Limitations for Google User Data

Our use of data received from Google APIs is limited to the practices disclosed in this privacy policy and complies with the Google API Services User Data Policy, including the Limited Use requirements. We do not use Google User Data to serve advertising, and we do not sell or share Google User Data with third parties except as necessary to provide the features you have enabled, as required by law, or as permitted with your explicit consent.
...
We collect only the PayPal User Data necessary to provide the features you have explicitly enabled. This may include:

- Your PayPal account email address and profile information (name, payer ID)
- Account verification status
- Transaction history, including payment details, dates, amounts, and statuses
- Refund and dispute information
- Invoice and subscription data
- Account balance information

We do not collect or store your PayPal login credentials, passwords, or full payment instrument details (such as full credit card numbers).

How We Use PayPal User Data
...
Third-Party Sharing of PayPal User Data

We do not sell, rent, or trade your PayPal User Data with third parties. PayPal User Data may only be shared with service providers performing services on our behalf, as required by law, or with your explicit consent. Our use of PayPal User Data complies with the PayPal Developer Agreement and applicable data protection laws.
...
We collect only the Meta User Data necessary to provide the advertising management features you have explicitly enabled. This may include:

- Your Meta user ID and public profile information
- A list of Facebook Pages you manage (Page IDs and names)
- A list of advertising accounts you have access to (account IDs, names, and currency)
- Instagram Professional accounts linked to your Facebook Pages (account IDs and usernames)
- Ad campaign structure and configuration (campaigns, ad sets, ads, and creatives)
- Ad performance metrics and insights (such as spend, reach, impressions, and actions)
- Meta Pixel information associated with your ad accounts
- Custom audiences and custom conversions within your ad accounts

We do not collect or store your Facebook login credentials or passwords. Access is maintained through OAuth tokens stored securely on our servers.
...
Third-Party Sharing of Meta User Data

We do not sell, rent, or trade your Meta User Data with third parties. Meta User Data may only be shared with service providers performing services on our behalf, as required by law, or with your explicit consent. Our use of Meta User Data complies with the Meta Platform Terms and applicable data protection laws.

CHANGES TO THIS PRIVACY STATEMENT
This privacy statement was drafted on March 28, 2024, and last updated on March 30, 2026. It is effective as of March 28, 2024. The English language version of this privacy statement is the controlling version regardless of any translation you may attempt. We reserve the right to change or update this statement from time to time. Please check our online and mobile resources periodically for such changes since all information collected is subject to the statement in place at that time.
...
To unsubscribe from email, phone, SMS, or robo-dialing mediums please send an email to info@vibey.im and include the phone number and/or email address you wish to be removed.
