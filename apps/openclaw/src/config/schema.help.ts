...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.promptMode":
    'Default system prompt mode for agents without an explicit per-agent override: "full" (all sections), "embedded" (omits OpenClaw CLI/docs/messaging sections), "platform" (strips OpenClaw identity/runtime language), or "vibey" (strict Vibey-owned minimal prompt contract). Hard fallback is "vibey" when unset.',
  "agents.list.*.promptMode":
    'System prompt mode: "full" (default, all sections), "embedded" (omits OpenClaw CLI/docs/messaging sections), "platform" (strips OpenClaw identity/runtime language for forward-facing agents), or "vibey" (strict Vibey-owned minimal prompt contract).',
  "agents.list[].promptMode":
    'System prompt mode: "full" (default, all sections), "embedded" (omits OpenClaw CLI/docs/messaging sections), "platform" (strips OpenClaw identity/runtime language for forward-facing agents), or "vibey" (strict Vibey-owned minimal prompt contract).',
