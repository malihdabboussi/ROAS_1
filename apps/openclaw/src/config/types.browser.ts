...
export type BrowserSsrfPolicyConfig = {
  /** When true, allow navigation to hosts that resolve to private/internal IPs. Default: false when omitted. */
...
export type BrowserConfig = {
  ...
  /** SSRF-style checks before http(s) navigations (DNS resolution / private IP blocking). */
