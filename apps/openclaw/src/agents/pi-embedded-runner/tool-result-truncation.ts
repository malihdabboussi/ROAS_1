 ...
 * A single successful tool result is one piece of the next prompt, and broad
 * read workflows often call several tools before synthesizing an answer.
 */
const MAX_TOOL_RESULT_CONTEXT_SHARE = 0.3;

/**
 * Hard character limit for a single tool result text block.
 * This acts as a safety net when we do not know the context window size.
 */
...
const TRUNCATION_SUFFIX =
  ...
  "cursor pagination to read the next batch.]";
