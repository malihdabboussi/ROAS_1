...
describe("resolveModel", () => {
  ...
  it("builds an openai-codex fallback for gpt-5.5-codex", () => {
    mockDiscoveredModel({
      provider: "openai-codex",
      modelId: "gpt-5.2-codex",
      templateModel: OPENAI_CODEX_TEMPLATE_MODEL,
    ...
    const result = resolveModel("openai-codex", "gpt-5.5-codex", "/tmp/agent");
  ...
  it("builds an openai-codex fallback for explicit gpt-5.5", () => {
    mockDiscoveredModel({
      provider: "openai-codex",
      modelId: "gpt-5.2-codex",
      templateModel: OPENAI_CODEX_TEMPLATE_MODEL,
