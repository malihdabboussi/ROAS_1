...
describe("model-selection", () => {
  ...
  describe("parseModelRef", () => {
    ...
    it("normalizes openai gpt-5.5 codex refs to openai-codex provider", () => {
      expect(parseModelRef("openai/gpt-5.5-codex", "anthropic")).toEqual({
        provider: "openai-codex",
        model: "gpt-5.5-codex",
      });
      expect(parseModelRef("gpt-5.5-codex", "openai")).toEqual({
        provider: "openai-codex",
        model: "gpt-5.5-codex",
      });
    });
