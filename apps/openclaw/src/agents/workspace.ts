...
export const DEFAULT_ROLE_FILENAME = "ROLE.md";
...
export function assertRuntimeWorkspacePath(
  dir: string,
  platform: NodeJS.Platform = process.platform,
) {
  if (platform !== "darwin" && (dir === "/Users" || dir.startsWith("/Users/"))) {
    throw new Error(`Invalid workspace path for runtime: ${dir}`);
  }
}
...
export async function ensureAgentWorkspace(params?: {
  ...
  assertRuntimeWorkspacePath(dir);
...
export async function loadWorkspaceBootstrapFiles(dir: string): Promise<WorkspaceBootstrapFile[]> {
  ...
  const entries: Array<{
    ...
    },
    {
      ...
      filePath: path.join(resolvedDir, DEFAULT_ROLE_FILENAME),
    },
    {
