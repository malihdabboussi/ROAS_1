...
export function Tooltip({
  ...
  const reposition = useCallback(() => {
    ...
    if (side === 'top' && r.top - t.height - gap < padding) effectiveSide = 'bottom'
    else if (side === 'bottom' && r.bottom + gap + t.height + padding > window.innerHeight)
      effectiveSide = 'top'
    else if (side === 'left' && r.left - t.width - gap < padding) effectiveSide = 'right'
    else if (side === 'right' && r.right + gap + t.width + padding > window.innerWidth)
      effectiveSide = 'left'
